...
path1 = './data1/inh_yeast_asymm_{0}.npy'.format(rank)  # path where the calculated values will be saved
path2 = './data1/prog_{0}.npy'.format(rank)  # path where progress made is recorded.
