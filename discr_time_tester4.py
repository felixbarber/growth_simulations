...
g1_std = np.linspace(0.02, 0.2, 2)
g2_std = np.linspace(0.0, 0.35, 8)
d_std = np.linspace(0.0, 0.25, 6)
#l_std = np.linspace(0.0, 0.25, 6)
#cd = np.linspace(0.5, 0.95, 8)

par1 = dict([('g1_std', 0.0), ('g2_std', 0.0), ('g1_thresh_std', 0.0), ('nstep', 1200), ('dt', 0.01), ('t_delay', 0.0)
            , ('initiator', 0), ('CD', 0.75), ('num_gen', 9), ('K', 1.0), ('td', 1.0), ('modeltype', 9), ('d_std', 0.0)])
...
if __name__=='__main__':
    ...
    X, Y, Z = len(g2_std), len(g1_std), len(d_std)
    a = np.zeros((X, Y, Z, 6, 2))
