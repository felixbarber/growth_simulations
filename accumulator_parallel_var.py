...
par1 = dict([('g1_std', 0.0), ('g2_std', 0.0), ('g1_thresh_std', 0.0), ('nstep', 1200), ('dt', 0.01), ('t_delay', 0.0)
            , ('initiator', 0), ('CD', 0.75), ('num_gen', 12), ('td', 1.0), ('modeltype', 2), ('l_std', 0.0),
             ('delta', 1.0)])
...
if __name__ == '__main__':
    ...
    X, Y, Z, W = len(cd), len(g1_std), len(g2_std), len(l_std)
        ...
        for j in range(Y):
            ...
            for k in range(Z):
                ...
                for h in range(W):
                    ...
                    a[i, j, k, :, :, h] = obs3[:6, :]
                    basepath = '/home/felix/simulation_data/accumulator_data/'
                    ...
                    np.save(basepath + 'tgrow_m_accumulator_model'+str(par1['modeltype'])+'_discr_genr_tree_cd_'
                    ...
                    np.save(basepath + 'tgrow_d_accumulator_model'+str(par1['modeltype'])+'_discr_genr_tree_cd_'
    ...
    if rank == 0:
        ...
        # plt.imshow(new_grid)
        # plt.show()
        np.save('accumulator_model'+str(par1['modeltype']), new_grid)
